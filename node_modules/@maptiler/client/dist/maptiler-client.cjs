...
function areSameLanguages(langA, langB, languageDictionary = Language) {
  ...
  return langAObj !== null && langBObj !== null && langAObj.flag === langBObj.flag;
}
...
function addBaseGeocodingOptions(searchParams, options) {
