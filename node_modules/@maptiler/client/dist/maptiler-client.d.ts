...
declare function canParsePixelData(): boolean;
 ...
 */
declare function getLanguageInfoFromKey(languageKey: string, languageDictionary?: {
 ...
 * Returns `null` if not found.
 */
declare function getLanguageInfoFromCode(languageCode: string, languageDictionary?: {
    [k: string]: LanguageInfo;
}): LanguageInfo | null;
/**
 ...
 * Returns `null` if not found.
 */
declare function getLanguageInfoFromFlag(languageFlag: string, languageDictionary?: {
    [k: string]: LanguageInfo;
}): LanguageInfo | null;
/**
 ...
 * By default, the language dictionary to look into is the one defined in this library, but another one could be provided
 */
declare function toLanguageInfo(lang: LanguageInfo | string, languageDictionary?: {
    [k: string]: LanguageInfo;
}): LanguageInfo | null;
/**
 ...
 */
declare function areSameLanguages(langA: string | LanguageInfo, langB: string | LanguageInfo, languageDictionary?: {
    [k: string]: LanguageInfo;
}): boolean;
...
type BaseGeocodingOptions = LanguageGeocodingOptions & {
    /**
...
type GeocodingPlaceType = "continental_marine" | "country" | "major_landform" | "region" | "subregion" | "county" | "joint_municipality" | "joint_submunicipality" | "municipality" | "municipal_district" | "locality" | "neighbourhood" | "place" | "postal_code" | "address" | "road" | "poi";
type CommonForwardAndReverseGeocodingOptions = BaseGeocodingOptions & {
    /**
...
type ByIdGeocodingOptions = BaseGeocodingOptions;
...
declare const MAP_STYLE_CONFIG: readonly [{
    readonly referenceStyleID: "STREETS_V2";
    readonly name: "Streets";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "streets-v2";
        readonly name: "Default v2";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"streets-v2\" is deprecated, use \"streets-v4\" instead";
    }, {
        readonly id: "streets-v2-dark";
        readonly name: "Dark v2";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"streets-v2-dark\" is deprecated, use \"streets-v4-dark\" instead";
    }, {
        readonly id: "streets-v2-light";
        readonly name: "Light v2";
        readonly variantType: "LIGHT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"streets-v2-light\" is deprecated, use \"streets-v4-light\" instead";
    }, {
        readonly id: "streets-v2-night";
        readonly name: "Night v2";
        readonly variantType: "NIGHT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"streets-v2-night\" is deprecated, use \"streets-v4-night\" instead";
    }, {
        readonly id: "streets-v2-pastel";
        readonly name: "Pastel v2";
        readonly variantType: "PASTEL";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"streets-v2-pastel\" is deprecated, use \"streets-v4-pastel\" instead";
    }];
}, {
    readonly referenceStyleID: "STREETS_V4";
    readonly name: "Streets";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "streets-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "streets-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "streets-v4-pastel";
    ...
    readonly referenceStyleID: "BASE_V4";
    readonly name: "Base";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "base-v4";
        ...
        readonly id: "base-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "base-v4-light";
        readonly name: "Light";
        readonly variantType: "LIGHT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "base-v4-ai";
        readonly name: "Base AI";
        readonly variantType: "AI";
        readonly description: "";
        readonly imageURL: "";
    }];
}, {
    readonly referenceStyleID: "OUTDOOR";
    readonly name: "Outdoor";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "outdoor-v2";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"outdoor-v2\" is deprecated, use \"outdoor-v4\" instead";
    }, {
        readonly id: "outdoor-v2-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"outdoor-v2-dark\" is deprecated, use \"outdoor-v4-dark\" instead";
    }];
}, {
    readonly referenceStyleID: "WINTER_V2";
    readonly name: "Winter";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "winter-v2";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "winter-v2-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "WINTER_V4";
    readonly name: "Winter";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "winter-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "winter-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "SATELLITE_V2";
    ...
    readonly variants: readonly [{
        ...
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"satellite\" is deprecated, use \"satellite-v4\" instead";
    }];
}, {
    readonly referenceStyleID: "HYBRID_V2";
    ...
    readonly referenceStyleID: "HYBRID_V4";
    readonly name: "Hybrid";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "hybrid-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly imageURL: "";
    }, {
        readonly id: "hybrid-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly imageURL: "";
    }];
}, {
    readonly referenceStyleID: "BASIC_V2";
    readonly name: "Basic";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "basic-v2";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"basic-v2\" is deprecated, use \"base-v4\" instead";
    }, {
        readonly id: "basic-v2-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "BRIGHT";
    readonly name: "Bright";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "bright-v2";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "bright-v2-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "bright-v2-light";
        readonly name: "Light";
        readonly variantType: "LIGHT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "bright-v2-pastel";
        readonly name: "Pastel";
        readonly variantType: "PASTEL";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "OPENSTREETMAP_V2";
    ...
    readonly variants: readonly [{
        ...
        readonly id: "openstreetmap-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "TOPO_V2";
    readonly name: "Topo";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "topo-v2";
        ...
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"topo-v2\" is deprecated, use \"topo-v4\" instead";
    }, {
        readonly id: "topo-v2-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"topo-v2-dark\" is deprecated, use \"topo-v4-dark\" instead";
    }, {
        readonly id: "topo-v2-shiny";
        readonly name: "Shiny";
        readonly variantType: "SHINY";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
    }, {
        readonly id: "topo-v2-pastel";
        readonly name: "Pastel";
        readonly variantType: "PASTEL";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"topo-v2-pastel\" is deprecated, use \"topo-v4-pastel\" instead";
    }, {
        readonly id: "topo-v2-topographique";
        readonly name: "Topographique";
        readonly variantType: "TOPOGRAPHIQUE";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"topo-v2-topographique\" is deprecated, use \"topo-v4-topographique\" instead";
    }];
}, {
    readonly referenceStyleID: "VOYAGER_V2";
    readonly name: "Voyager";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "voyager-v2";
        readonly name: "Default";
        readonly deprecated: true;
        readonly variantType: "DEFAULT";
        readonly description: "";
        ...
        readonly id: "voyager-v2-darkmatter";
        ...
        readonly id: "voyager-v2-positron";
        ...
        readonly id: "voyager-v2-vintage";
        readonly name: "Vintage";
        readonly deprecated: true;
        readonly variantType: "VINTAGE";
        readonly description: "";
        readonly imageURL: "";
    }];
}, {
    readonly referenceStyleID: "TONER_V2";
    readonly name: "Toner";
    readonly description: "";
    readonly deprecated: true;
    readonly deprecationMessage: "\"toner-v2\" is deprecated, and will be no longer be a default style in the future";
    readonly variants: readonly [{
        readonly id: "toner-v2";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"toner-v2\" is deprecated, and may be removed in future versions.";
    }, {
        readonly id: "toner-v2-background";
        readonly name: "Background";
        readonly variantType: "BACKGROUND";
        readonly deprecated: true;
        readonly description: "";
        readonly imageURL: "";
        readonly deprecationMessage: "\"toner-v2-background\" is deprecated, and may be removed in future versions.";
    }, {
        readonly id: "toner-v2-lite";
        readonly name: "Lite";
        readonly variantType: "LITE";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"toner-v2-lite\" is deprecated, and may be removed in future versions.";
    }, {
        readonly id: "toner-v2-lines";
        readonly name: "Lines";
        readonly variantType: "LINES";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"toner-v2-lines\" is deprecated, and may be removed in future versions.";
    }];
}, {
    readonly referenceStyleID: "DATAVIZ_V2";
    readonly name: "Dataviz";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "dataviz";
        readonly name: "Default";
        ...
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"dataviz\" is deprecated, use \"dataviz-v4\" instead";
    }, {
        readonly id: "dataviz-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"dataviz-dark\" is deprecated, use \"dataviz-v4-dark\" instead";
    }, {
        readonly id: "dataviz-light";
        readonly name: "Light";
        readonly variantType: "LIGHT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"dataviz-light\" is deprecated, use \"dataviz-v4-light\" instead";
    }];
}, {
    readonly referenceStyleID: "BACKDROP_V2";
    ...
    readonly variants: readonly [{
        ...
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"backdrop\" is deprecated, use \"backdrop-v4\" instead";
    }, {
        readonly id: "backdrop-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"backdrop-dark\" is deprecated, use \"backdrop-v4-dark\" instead";
    }, {
        readonly id: "backdrop-light";
        readonly name: "Light";
        readonly variantType: "LIGHT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"backdrop-light\" is deprecated, use \"backdrop-v4-light\" instead";
    }];
}, {
    readonly referenceStyleID: "OCEAN_V2";
    readonly name: "Ocean";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "ocean";
        ...
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"ocean\" is deprecated, use \"ocean-v4\" instead";
    }];
}, {
    readonly referenceStyleID: "AQUARELLE_V2";
    readonly name: "Aquarelle";
    readonly description: "Watercolor map for creative use";
    readonly variants: readonly [{
        readonly id: "aquarelle";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"aquarelle\" is deprecated, use \"aquarelle-v4\" instead";
    }, {
        readonly id: "aquarelle-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"aquarelle-dark\" is deprecated, use \"aquarelle-v4-dark\" instead";
    }, {
        readonly id: "aquarelle-vivid";
        readonly name: "Vivid";
        readonly variantType: "VIVID";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"aquarelle-vivid\" is deprecated, use \"aquarelle-v4-vivid\" instead";
    }];
}, {
    readonly referenceStyleID: "LANDSCAPE_V2";
    readonly name: "Landscape";
    readonly description: "Terrain map for data overlays and visualisations";
    readonly variants: readonly [{
        ...
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"landscape\" is deprecated, use \"landscape-v4\" instead";
    }, {
        readonly id: "landscape-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"landscape-dark\" is deprecated, use \"landscape-v4-dark\" instead";
    }, {
        readonly id: "landscape-vivid";
        readonly name: "Vivid";
        readonly variantType: "VIVID";
        readonly description: "";
        readonly imageURL: "";
        readonly deprecated: true;
        readonly deprecationMessage: "\"landscape-vivid\" is deprecated, use \"landscape-v4-vivid\" instead";
    }];
}, {
    readonly referenceStyleID: "LANDSCAPE_V4";
    readonly name: "Landscape";
    readonly description: "Terrain map for data overlays and visualisations";
    readonly variants: readonly [{
        readonly id: "landscape-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "landscape-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "landscape-v4-vivid";
        readonly name: "Vivid";
        readonly variantType: "VIVID";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "SATELLITE_V4";
    readonly name: "Satellite v4";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "satellite-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "satellite-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "DATAVIZ_V4";
    readonly name: "Dataviz";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "dataviz-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "dataviz-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "dataviz-v4-light";
        readonly name: "Light";
        readonly variantType: "LIGHT";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "OUTDOOR_V4";
    readonly name: "Outdoor";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "outdoor-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "outdoor-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "BACKDROP_V4";
    readonly name: "Backdrop";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "backdrop-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "backdrop-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "backdrop-v4-light";
        readonly name: "Light";
        readonly variantType: "LIGHT";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "AQUARELLE_V4";
    readonly name: "Aquarelle";
    readonly description: "Watercolor map for creative use";
    readonly variants: readonly [{
        readonly id: "aquarelle-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "aquarelle-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "aquarelle-v4-vivid";
        readonly name: "Vivid";
        readonly variantType: "VIVID";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "OCEAN_V4";
    readonly name: "Ocean";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "ocean-v4";
        readonly name: "Default";
        readonly variantType: "DEFAULT";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "ocean-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    ...
    readonly referenceStyleID: "TOPO_V4";
    readonly name: "Topo";
    readonly description: "";
    readonly variants: readonly [{
        readonly id: "topo-v4";
        ...
        readonly id: "topo-v4-dark";
        readonly name: "Dark";
        readonly variantType: "DARK";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "topo-v4-pastel";
        readonly name: "Pastel";
        readonly variantType: "PASTEL";
        readonly description: "";
        readonly imageURL: "";
    }, {
        readonly id: "topo-v4-topographique";
        readonly name: "Topographique";
        readonly variantType: "TOPOGRAPHIQUE";
        readonly description: "";
        readonly imageURL: "";
 ...
 */
declare const defaultReferenceStyleMap: {
    readonly STREETS: "STREETS_V4";
    readonly BASIC: "BASIC_V2";
    readonly BASE: "BASE_V4";
    readonly LANDSCAPE: "LANDSCAPE_V4";
    readonly AQUARELLE: "AQUARELLE_V4";
    readonly SATELLITE: "SATELLITE_V4";
    readonly WINTER: "WINTER_V4";
    readonly HYBRID: "HYBRID_V4";
    readonly OCEAN: "OCEAN_V4";
    readonly TONER: "TONER_V2";
    readonly TOPO: "TOPO_V4";
    readonly OPENSTREETMAP: "OPENSTREETMAP_V2";
    readonly DATAVIZ: "DATAVIZ_V4";
    readonly BACKDROP: "BACKDROP_V4";
    readonly VOYAGER: "VOYAGER_V2";
};
type ConfigID = (typeof MAP_STYLE_CONFIG)[number]["referenceStyleID"];
type ConfigVariant<T extends ConfigID> = Extract<(typeof MAP_STYLE_CONFIG)[number], {
    referenceStyleID: T;
